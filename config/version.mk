...
EXTENDED_MOD_VERSION := LeChenOS-$(EXTENDED_VERSION)-$(EXTENDED_BUILD_DATE)-$(EXTENDED_BUILD_TYPE)
EXTENDED_FINGERPRINT := LeChenOS/$(EXTENDED_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(EXTENDED_BUILD_DATE)
...
EXTENDED_DISPLAY_VERSION := LeChenOS-$(EXTENDED_VERSION)-$(EXTENDED_BUILD_TYPE)
