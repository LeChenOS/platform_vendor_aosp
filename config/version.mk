...
TARGET_PRODUCT_SHORT := $(subst ,,$(CUSTOM_BUILD))

SUPERIOR_VERSION := LeChenOS-$(SUPERIOR_MOD_VERSION)-$(CURRENT_DEVICE)-$(SUPERIOR_BUILD_TYPE)-$(CUSTOM_BUILD_DATE)

SUPERIOR_FINGERPRINT := LeChenOS/$(SUPERIOR_MOD_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(CUSTOM_BUILD_DATE)
...
SUPERIOR_DISPLAY_VERSION := LeChenOS-$(SUPERIOR_MOD_VERSION)-$(SUPERIOR_BUILD_TYPE)
